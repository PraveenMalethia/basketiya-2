<template>
  <header class="opacity-95 backdrop-filter backdrop-blur-lg background-transparent sticky top-0 z-50 text-gray-400 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 body-font ">
